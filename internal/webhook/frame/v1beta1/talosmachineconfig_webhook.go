...
func SetupTalosMachineConfigWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &framev1beta1.TalosMachineConfig{}).
		WithValidator(&TalosMachineConfigCustomValidator{}).
		Complete()
}

// +kubebuilder:webhook:path=/validate-frame-plume-labs-io-v1beta1-talosmachineconfig,mutating=false,failurePolicy=fail,sideEffects=None,groups=frame.plume-labs.io,resources=talosmachineconfigs,verbs=create;update,versions=v1beta1,name=vtalosmachineconfig-v1beta1.kb.io,admissionReviewVersions=v1

type TalosMachineConfigCustomValidator struct{}

func (v *TalosMachineConfigCustomValidator) ValidateCreate(_ context.Context, obj *framev1beta1.TalosMachineConfig) (admission.Warnings, error) {
	return validateTalosMachineConfig(obj)
}

func (v *TalosMachineConfigCustomValidator) ValidateUpdate(_ context.Context, _, newObj *framev1beta1.TalosMachineConfig) (admission.Warnings, error) {
	return validateTalosMachineConfig(newObj)
}

func (v *TalosMachineConfigCustomValidator) ValidateDelete(_ context.Context, _ *framev1beta1.TalosMachineConfig) (admission.Warnings, error) {
	return nil, nil
}

func validateTalosMachineConfig(tmc *framev1beta1.TalosMachineConfig) (admission.Warnings, error) {

...
const NetcfgRerunScript = `#!/bin/sh
...
# Everything above is inert on its own: see NetcfgRerunScript. This is the
...
// (NetcfgRerunScript) that re-runs netcfg. It is required and refused
...
// are gone.
func RenderPreseed(s Spec, runURL string) (string, error) {

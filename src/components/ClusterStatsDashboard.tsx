...
export function ClusterStatsDashboard({ stats, compact = false }: ClusterStatsProps) {
    ...
    return (
      <div className="flex items-center gap-4 font-mono text-sm">
        ...
        {stats.degradedNodes > 0 && (
          <div className="flex items-center gap-2">
            <span className="text-[oklch(0.75_0.18_75)] font-semibold">{stats.degradedNodes}</span>
